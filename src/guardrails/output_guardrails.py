...
def content_filter(response: str) -> dict:
    ...
    PII_PATTERNS = {
        ...
        "Markdown Image": r"!\[.*?\]\((.*?)\)", # Prevents UI Exfiltration
    }
...
6. If the response contains any code, poetry, or anything other than a dry banking answer, classify as UNSAFE.
        ...
        *,
        ...
        if self.use_llm_judge:
            ...
            if not judge_result["safe"]:
                ...
                llm_response.content = types.Content(
                    role="model",
                    parts=[types.Part.from_text(text="I cannot fulfill this request due to security policies.")],
                )
